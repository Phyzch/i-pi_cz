...
class SOAPDescriptor(InternalCoordinates):
    ...
    def __init__(self, 
        ...
        self.feature_length = feature_vectors.flatten().shape[0] # n_features * n_positions
    ...
    def second_derivatives(self, xyz):
        ...
        second_derivatives = np.zeros((self.feature_length, self.natom, 3, self.natom * 3))
        ...
        second_derivatives = np.reshape(second_derivatives, (self.feature_length, self.natom, 3, self.natom, 3))
