...
# invcm2au: convert cm^-1 to atomic unit of frequency used in the program.
...
class DoubleWell_driver(Dummy_driver):
    ...
    def check_arguments(self):
        ...
        if self.args == "":
            ...
            try:
                # arglist = self.args.split(",")  # this is bug in the code. self.args has already been splitted in the dummy.init file.
                arglist = self.args
    ...
    def __call__(self, cell, pos):
        ...
        pot = 0
        pos3 = pos.reshape(-1, 3)   # result will have 3 columns. DW potential along 1 direction, then harmonic potential along 2 other directions.
