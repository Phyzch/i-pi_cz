...
class MAPNEBGPRMover(Motion):
    ...
    def neb_loop(self, outer_loop_step):
        ...
        outrange_bead_index = -1 # index for beads that move out of trusted region that causes the early stop.
    ...
    def update_GPR_model(self, early_stop_bool, outrange_bead_index, step):
        ...
        if early_stop_bool:
            # in this case, one bead moves out of trust region. We add this bead into the training data.
        ...
        if attempt_exit_bool:
            # TODO: To improve the convergence: 
            # TODO: delete early stage training data in GPR, as they are far away from current configuration.
            # TODO: decrease the step size as we approach the convergence.
